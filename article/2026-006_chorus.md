...
| **EPInformer-seq** | 2,114 bp | 1 bp / element-level | Per-cell enhancer activity (DNase cut-sites + H3K27ac) across 11 Roadmap cell types — base-resolution profiles plus a compact per-element scalar |
...
variant_effects = oracle.predict_variant_effect(
    "chr1:109273912-109276025",   # 2,114 bp window centred on the variant
