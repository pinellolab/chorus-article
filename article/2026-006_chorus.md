...
![Multi-oracle readout for rs12740374 and a side-by-side comparison of what the models predicted against what the 2010 study measured.](../figures/fig_sort1_comparison.png "Figure 2. Left, the per-layer multi-oracle table and a single-axis genome-browser view of every oracle's signal around SORT1. Right, the model predictions placed next to the experimental ground truth from Musunuru et al. (2010). The models recover the direction and the mechanism at every layer; the one place they fall short is magnitude.")
...
> merged to chorus main (PRs #92/#93): (a) LD proxies must be scored on their *own* genome
...
> 56-variant credible set in BOTH oracles** — AlphaGenome (lung-fibroblast tracks; composite
